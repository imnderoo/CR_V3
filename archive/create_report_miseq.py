...
def main():
	...
	for sample_id in sample_dict:
		...
		generate_report(script_folder, report_folder, av_file, cnv_dict, report_qc_dict[sample_id], meta_dict, sample_dict[sample_id]['gene_exons'], sample_dict[sample_id]['failed_exons'], alt_plot, base_plot, boxplots_list, cnv_plots_list)
...
def generate_report(script_folder, report_folder, flatten_av, cnv_dict, qc_dict, meta_dict, genes_exons_summary, failed_exons, alt_plot, base_plot, boxplots_list, cnv_plots_list):
